...
* **Human evaluation**: The most reliable evaluation is the acceptance rate by users or comparisons made by humans. It's very common to integrate direct (i.e. thumps up/down, 1-5 star rating) and indirect feedback (regenerate or copy answer) buttons in the chat frontend. Logging this kind of user feedback in addition to the chat traces helps to identify potential areas for improvement. Tools, such as [LangSmith](https://docs.smith.langchain.com/evaluation/capturing-feedback) can help with this kind of task.
